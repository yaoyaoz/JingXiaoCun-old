		...
		<table border="1" cellspacing="0" cellpadding="15" align="center" width="60%">
			<tr>
				...
				<td>
					...
					>出库</input>
					<font color="red">${formBean.errors.in_or_out_type}</span>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					<font color="red">${formBean.errors.store_name}</span>
				</td>
			</tr>
			<tr>
				<td>商品名称</td>
				<td>
					...
					<font color="red">${formBean.errors.goods_name}</span>
				</td>
			</tr>
			<tr>
				<td>入/出库数量 </td>
				<td>
					...
					<font color="red">${formBean.errors.goods_num}</span>
				</td>
			</tr>
			<tr>
				<td>单价</td>
				<td>
					...
					<font color="red">${formBean.errors.goods_price}</span>
				</td>
			</tr>
			<tr>
				<td>入/出库日期</td>
				<td>
					...
					<font color="red">${formBean.errors.in_or_out_date}</span>
				</td>
			</tr>
			<tr>
				<td>
					<input type="submit" value="修改" />
					<font color="red">${message}</span>
				</td>
				<td></td>
			</tr>
		</table>
